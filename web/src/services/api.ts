...
export const api = {
  ...
  async getGallery(params?: { filter?: string; search?: string; limit?: number | 'all'; cursor?: string }): Promise<{ media: FileItem[]; nextCursor?: string | null; hasMore?: boolean; devices?: any[] }> {
